...
public:
    ...
    void AddMapLine(MapLine* pML); //new

    void AddCamera(GeometricCamera* pCam);

    /* All methods without Map pointer work on current map */
    void SetReferenceMapPoints(const std::vector<MapPoint*> &vpMPs);
    void SetReferenceMapLines(const std::vector<MapLine*> &vpMLs); //new
    ...
    std::vector<MapLine*> GetAllMapLines(); //new
    std::vector<MapPoint*> GetReferenceMapPoints();
    std::vector<MapLine*> GetReferenceMapLines(); //new
    ...
    LineVocabulary* GetLineVocabulary();
