...
using namespace cv;
//自添加 using namespace line_descriptor;
...
public:
    ...
    // 自添加 MapLine observation functions
    ...
    void SetLineVocabulary(LineVocabulary* pLineVoc);
...
public:
    ...
    // 自添加 KeyLines，stereo coordinate and descriptors
...
protected:
    ...
    // 自添加 MapLines associated to keylines
...
public:
    ...
    const std::vector<cv::line_descriptor::KeyLine> mvKeylinesRight; //new

    const int NLeft, NRight;
    //const int NleftLine, NrightLine; // new

    std::vector< std::vector <std::vector<size_t> > > mGridRight;
    std::vector< std::vector <std::vector<size_t> > > mGridRightForLine; // new
