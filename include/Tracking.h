...
public:
    Tracking(System* pSys, ORBVocabulary* pVoc, LineVocabulary* pVoc_l, FrameDrawer* pFrameDrawer, MapDrawer* pMapDrawer, Atlas* pAtlas,
...
public:
    ...
    std::vector<int> mvIniLineMatches; //new
    std::vector<cv::Point2f> mvbPrevMatched; //, mvbPrevMatchedLine
    ...
    std::vector<MapLine*> GetLocalMapMLS();
...
protected:
    ...
    bool TrackReferenceKeyFrameWithLine(); //new
    void UpdateLastFrame();
    bool TrackWithMotionModel();
    bool TrackWithMotionModelWithLine(); //new
    ...
    void UpdateLocalPointsAndLines(); //new
    void UpdateLocalKeyFrames();

    bool TrackLocalMap();
    bool TrackLocalMap_old();
    void SearchLocalPoints();
    void SearchLocalPointsAndLines(); //new
    ...
    LineVocabulary* mpLineVocabulary; //line
    ...
    int mnMatchesInliers_l;   // new 线特征
    ...
    list<MapLine*> mlpTemporalLines; //new
