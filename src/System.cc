    ...
    mbActivateLocalizationMode(false), mbDeactivateLocalizationMode(false)
{
    ...
    cout << endl << "PLI_SLAM 2021 FangQH.USL.NUAA." << endl;
    cout << endl <<
    ...
    mpKeyFrameDatabase = new KeyFrameDatabase(*mpVocabulary, *mpVocabulary_l);
    ...
    mpLoopCloser = new LoopClosing(mpAtlas, mpKeyFrameDatabase, mpVocabulary, mpVocabulary_l, mSensor!=MONOCULAR); // mSensor!=MONOCULAR);
