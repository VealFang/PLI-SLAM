...
namespace ORB_SLAM3
{
    SystemSetting::SystemSetting(ORBVocabulary* pORBVoc, LineVocabulary* pLineVoc):
        pORBvocabulary(pORBVoc),pLinevocabulary(pLineVoc)
        {
    ...
    {
        cout<<endl<<"Loading System Parameters from:"<<strSettingPath<<endl;
